...
$sql = "SELECT baslik, aciklama, resim, kayit_tarihi, oyun, saat, katilim, yayin_platformu, lokasyon, aktif, tarih 
        FROM etkinlikler 
...
<head>
    ...
    <title>Etkinlikler - Bi Organizasyon</title>
...
<!-- Etkinlikler -->
<section>
    <h2 style="color: yellow; text-align: center;">Yaklaşan Etkinlikler</h2>

    <section style="max-width: 1000px; margin: 60px auto 20px auto; color: white; font-size: 20px; line-height: 1.0; text-align: center;">
        <p>Mobil oyunlar dünyasında heyecan dorukta! PUBG Mobile, Free Fire gibi popüler oyunlar için düzenlenen turnuvalar, oyunculara rekabet dolu ve eğlenceli anlar sunuyor.</p>
        <p>Öte yandan, bilgisayar oyunları alanında da büyük turnuvalar hız kesmeden devam ediyor. League of Legends, CS:GO ve Dota 2 gibi e-spor devleri, bölgesel ve uluslararası şampiyonalarda oyuncuları bir araya getiriyor.</p>
        <p>İster mobil ister bilgisayar oyuncusu olun, yakında gerçekleşecek turnuva etkinlikleriyle rekabetin ve eğlencenin tadını çıkarabilirsiniz!</p>
    </section>
